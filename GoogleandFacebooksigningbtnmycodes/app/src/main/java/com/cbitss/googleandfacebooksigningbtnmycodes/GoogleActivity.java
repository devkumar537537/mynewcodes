            ...
            public void onClick(View view) {
                ...
                googleSignInClient.signOut().addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete( Task<Void> task) {
                        ...
                        {
                            Toast.makeText(GoogleActivity.this, "you signout", Toast.LENGTH_SHORT).show();
    ...
    private void firebaseAuthWithGoogle(String idToken) {
        ...
        firebaseAuth.signInWithCredential(googleauthcrediatl).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful())
                {
                    Toast.makeText(GoogleActivity.this, "LogIn Success full", Toast.LENGTH_SHORT).show();
                    FirebaseUser user = firebaseAuth.getCurrentUser();
                    updateUI(user);
                }else
                {
                    Toast.makeText(GoogleActivity.this, "error "+task.getException(), Toast.LENGTH_SHORT).show();
